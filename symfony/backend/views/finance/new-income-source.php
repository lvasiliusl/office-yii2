...
$this->title = 'New Income Source';?>
<?php Pjax::begin(['id' => 'income_source']); ?>
<div class="page-title">
    <h3>New Income Source</h3>
    <div class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?= Url::to(['/income-source']); ?>">Income Source</a>
            </li>
            <li class="active">New Income Source</li>
        </ol>
    </div>
</div>
<div id="main-wrapper">
                    ...
                    <div class="table-responsive">
                        <div id="example_wrapper" class="dataTables_wrapper">
                            ...
                            <div class="form-group">
                                ...
                                <?= $form->field($model, 'commission')->textInput(['class' => 'form-control'])->label(false) ?>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <?= $form->field($model, 'commission_type')->dropDownList(['fixed' => 'Fixed', 'percentage' => 'Percentage'])->label(false) ?>
                            </div>
