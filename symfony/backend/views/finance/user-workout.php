            ...
            <div class="panel panel-white">
                <div class="panel-heading">
                    ...
                    <div class="text-right">
                        <?= Html::a('', ['workout/user-workout', 'month' => $prev_month, 'side_month' => '-1', 'year' => $year, 'id' => $userbalance->user_id], [ 'class' => 'fc-prev-button fc-button fc-state-default fc-corner-left fc-icon fc-icon-left-single-arrow'])?> <!--<span class=""></span></button>-->
                        <span><?= $model->date; ?></span>
                            <?= Html::a('', ['workout/user-workout', 'month' => $next_month, 'side_month' => '+1', 'year' => $year, 'id' => $userbalance->user_id], [ 'class' => 'fc-next-button fc-button fc-state-default fc-corner-right fc-icon fc-icon-right-single-arrow'])?><!-- <span class=""></span></button> -->
                    </div>
                    <div id="chart"></div>
                </div>
            </div>
