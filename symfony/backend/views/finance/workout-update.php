...
$this->registerJsFile('/admin/js/workoutupdate-form.js', ['depends' => 'yii\web\JqueryAsset']);
...
<?php Pjax::begin(['id' => 'edit_workout']); ?>
                        ...
                        <div id="example_wrapper" class="dataTables_wrapper">
                            ...
                            <div class="form-group">
                                ...
                                <div class="field-workout-datepicker">
                                    <input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy" name="WorkoutUpdate[workout_date]" value="<?=$model->workout_date;?>">
                                </div>
                            </div>

                            <div id="fixed_type" class="form-group <?= $model->rate_type === 'fixed' ? '' : 'hidden' ?>">
                                <label>Fixed</label>
                            ...
                            <div id="hourly_type" class="form-group <?= $model->rate_type === 'hourly' ?  '' :  'hidden' ?>">
                                <div class="form-group">
                                    <label>Rate</label>
