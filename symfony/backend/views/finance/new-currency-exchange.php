...
$this->title = 'New Currency Exchange';?>
<?php Pjax::begin(['id' => 'currency_exchange']); ?>
<div class="page-title">
    <h3>New Currency Exchange</h3>
    <div class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?= Url::to(['/currency-exchange']); ?>">Currency Exchange</a>
            </li>
            <li class="active">New Currency Exchange</li>
        </ol>
    </div>
</div>
<div id="main-wrapper">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <div id="example_wrapper" class="dataTables_wrapper">
                            ...
                            <div class="form-group">
                                <label>Rate</label>
                                <?= $form->field($model, 'rate')->textInput(['class' => 'form-control'])->label(false) ?>
                            </div>
