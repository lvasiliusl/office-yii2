...
class UserForm extends Model {
    ...
    public function load($data, $formName = null) {
        ...
        if( $this->id ) {
            $this->_user = UserForm::findOne(['id' => $this->id]);
        } else {
            $this->_user = new User();
        }
        ...
        $this->_user->salary_type = $this->salary_type;
        $this->_user->salary = $this->salary;
        $this->_user->currency_id = $this->currency_id;
    ...
    public function save()
    {
        ...
        if(Yii::$app->user->can('manage' . ucfirst($this->role)) && $this->validate() ){
